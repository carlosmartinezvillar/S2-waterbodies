...
if __name__ == "__main__":
	...
	dataloaders = {
		'training': torch.utils.data.DataLoader(tr_ds,
			batch_size=HP['BATCH'],drop_last=False,shuffle=True,num_workers=10,pin_memory=True),
		'validation': torch.utils.data.DataLoader(va_ds,
			batch_size=HP['BATCH'],drop_last=False,shuffle=False,num_workers=10,pin_memory=True)
	}
